...
public class Triangle extends Solid {
    public Triangle(){
        vertexBuffer.add(new Vertex(new Point3D(8, 6, 5), new Col(0, 125, 0), new Vec2D(10,10)));
        vertexBuffer.add(new Vertex(new Point3D(3, 8, 6), new Col(255, 125, 200), new Vec2D(2,6)));
